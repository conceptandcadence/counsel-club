...
<template>
	<Composer :templates="queryResult.templates" :variables="queryResult.variables" :dataEntities="queryResult.dataEntities" :flows="queryResult.flows" :settings="queryResult.settings" />
</template>
